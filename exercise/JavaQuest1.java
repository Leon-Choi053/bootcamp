 ...
 * Expected Output:
 * 
 * I am going to add two numbers together: The first one: 31 //The second one: 42 //The sum is 73 //The subtraction reuslt is 11 //The another sum result is 130 //The variable varB is false // The
 * variable varC is true //The variable fnumber is -130.2 //The variable dnumber is -20.5 //The variable reminder is 12 //The variable result is 3
 */
...
public class JavaQuest1 {
  ...
  public static void main(String[] args) {
    ...
    int b = 3;
    int reminder = a - b;
    System.out.println("The variable reminder is " + reminder * 3);
